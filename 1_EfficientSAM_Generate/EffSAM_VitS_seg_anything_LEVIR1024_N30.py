...
def main():
    ...
    SrcDir = r'D:\2_Experiments\3_Change_Detection\1_dataset\LEVIR_CD\LEVIR_CD_1024\st_train\A'
    DstDir_masks  = './genarate_results/LEVIR1024/st_train/masks_vits/' + str(GRID_SIZE) + '/'
    DstDir_colors = './genarate_results/LEVIR1024/st_train/colors_vits/'+ str(GRID_SIZE) + '/'
    DstDir_img_colors = './genarate_results/LEVIR1024/st_train/img_colors_vits/' + str(GRID_SIZE) + '/'
