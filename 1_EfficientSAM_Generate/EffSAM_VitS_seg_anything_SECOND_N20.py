...
def main():
    ...
    SrcDir = r'D:\2_Experiments\3_Change_Detection\1_dataset\SECOND\st_train\A'
    DstDir_masks  = './genarate_results/SECOND/st_train/masks_vits/' + str(GRID_SIZE) + '/'
    DstDir_colors = './genarate_results/SECOND/st_train/colors_vits/'+ str(GRID_SIZE) + '/'
    DstDir_img_colors = './genarate_results/SECOND/st_train/img_colors_vits/'+ str(GRID_SIZE) + '/'
