...
class Options:
    def __init__(self):
        ...
        parser.add_argument("--load_from", type=str, default=r'checkpoints\ST_LEVIR1024_MyNet\Val_best_ST_LEVIR1024_MyNet_epoch24_OA86.44_F34.37_mF63.40_IoU20.75_mIoU53.34_Recall69.71_Precision22.80_Kappa28.91_loss0.3348.pth')
        self.parser = parser
