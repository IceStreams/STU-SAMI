...
from datasets import ST_SECOND as dataset
...
class Options:
    def __init__(self):
        ...
        parser.add_argument("--data_name", type=str, default="ST_SECOND")
        parser.add_argument("--net_name", type=str, default="MyNet")
        parser.add_argument("--image_size", type=int, default=512)
        parser.add_argument("--test_batch_size", type=int, default=1)
        parser.add_argument("--load_from", type=str, default=r'checkpoints\ST_SECOND_MyNet\Val_best_ST_SECOND_MyNet_epoch49_OA82.29_F57.08_mF72.96_IoU39.94_mIoU59.93_Recall59.71_Precision54.67_Kappa45.95_loss0.6261.pth')
        self.parser = parser
