...
#SECOND
mean_all, std_all = [0.44032501, 0.44768481, 0.46021119], [0.19152635, 0.18276186, 0.18824190]
mean_A, std_A = [0.44473977, 0.44741134, 0.45669677], [0.18938797, 0.18139730, 0.18875079]
mean_B, std_B = [0.43591024, 0.44795829, 0.46372560], [0.19349817, 0.18407269, 0.18762256]
mean_general, std_general = [0.485, 0.456, 0.406], [0.229, 0.224, 0.225]

# Utilize your own path here
root_bt = r'D:\2_Experiments\3_Change_Detection\1_dataset\SECOND'
root_st = r'D:\2_Experiments\3_Change_Detection\1_dataset\SECOND'
...
class ChangeDataset_BCD_ST(Data.Dataset):
    def __init__(self, mode):
        ...
        self.num_factor = [25,30,35]
        self.image1_dir = os.path.join(root_st, self.mode, 'A')
        self.label1_dir = os.path.join(root_st, self.mode, 'EfficientSAM_VitS_mask_N5_to_N30', 'masks_vits', '20')
...
class ChangeDataset_BCD_BT(Data.Dataset):
    def __init__(self, mode):
        ...
        self.label_dir = os.path.join(root_bt, self.mode, 'label_bn_vis')
