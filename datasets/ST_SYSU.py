...
LastEditTime: 2025-07-14 15:49:04
...
#SYSU_CD
mean_all, std_all = [0.39952442, 0.50678227, 0.43011833], [0.23043115, 0.18368261, 0.18275357]
mean_A, std_A = [0.39638376, 0.52750225, 0.46359193], [0.24285969, 0.18389510, 0.18065630]
mean_B, std_B = [0.40266508, 0.48606229, 0.39664474], [0.21724499, 0.18111455, 0.17866188]
mean_general, std_general = [0.485, 0.456, 0.406], [0.229, 0.224, 0.225]

# Utilize your own path here
root_bt = r'D:\2_Experiments\3_Change_Detection\1_dataset\SYSU-CD'
root_st = r'D:\2_Experiments\3_Change_Detection\1_dataset\SYSU-CD'
...
class ChangeDataset_BCD_ST(Data.Dataset):
    def __init__(self, mode):
        ...
        self.label1_dir = os.path.join(root_st, self.mode, 'EfficientSAM_VitS_mask_N5_to_N30', 'masks_vits', '10')
